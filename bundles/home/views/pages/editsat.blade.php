 ...
 <div id="highlighted">
    ...
    <div class="pull-left">
      ...
      //  dd($satellite);
        ?>
        @endif
        {{Form::open_for_files('home/satellites/editor', 'POST');}}
        <input type ="hidden" name="id" value="{{$satellite->id}}">
        <span class="span2"><b>Satellite Name:</b></span><span class="span4"><input type="text"  class="input-block-level"  placeholder="Name of the Observatory"  name ="satellite_name" value ="{{$satellite->name}}"required></span><br>
        <span class="span2"><b>Companies:</b></span><span class="span4"><input type="text" id="event_from_date" class="input-block-level"  name ="companies" placeholder="Companies Involved" value ="{{$satellite->companies}}" required></span><br>
        <span class="span2"><b>Type:</b></span><span class="span4"><input type="text" class="input-block-level" name ="type" placeholder="Type of Satellite" value="{{$satellite->type}}" required></span><br>

        <span class="span2"><b>Orbit Height:</b></span><span class="span4"><input type="text" class="input-block-level" name ="orbit_height" placeholder="Height of Orbit" value="{{$satellite->orbit_height}}" required></span><br>
        ...
        <span class="span2"></span><span class="span4"><br><button class="btn btn-inverse" type="submit">Edit Satellite</button></span><br>
        </form>
    </div>
